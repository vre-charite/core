    ...
    <Document>
      <Page size="A4" style={styles.page}>
        <View style={styles.header}>
          <Text style={styles.headerText}>{new Date().toString()}</Text>
        ...
        <View style={styles.formGroup}>
          ...
          <Text style={styles.text}>
            Cookies are small text files placed on your computer. Some cookies
            are functional session cookies which are used to provide the user
            with the experience of a session: e.g. they track login details,
            remember user choices and preferences, and in some instances
            determine site permissions. Other cookies are used to provide
            statistics: e.g. they provide, in anonymous form, the number of
            visitors accessing a website, features users access during website
            visits, and the general location of the user based on IP address.
          </Text>
          <Text style={styles.text}>
            This VRE website uses only strictly necessary cookies — these
            cookies are essential for the proper operation of the website,
            allowing you to browse the website and use its features such as
            accessing secure areas of the site. This website protects your
            privacy by not creating cookies which contain personal data. The
            following list describes the types of cookies used on the VRE
            website.
          </Text>
          <View style={styles.formGroup}>
            <Text style={styles.subtext}>
              • Access token: An encoded token that is used to mark user's
              identity and access to services.
            </Text>
            <Text style={styles.subtext}>
              • Refresh token: An encoded token that is used to refresh user's
              session.
            </Text>
            <Text style={styles.subtext}>
            ...
            <Text style={styles.subtext}>
              • Login status: Indicates whether or not a user is logged into the
              VRE .
            </Text>
            <Text style={styles.subtext}>
              • Terms of Use Notification: Indicates whether or not a user has
              acknowledged the applicable Terms of Use and Privacy Policy
              notifications.
            </Text>
          </View>
        </View>
        ...
        <View style={styles.formGroup}>
          ...
          <Text style={styles.text}>
            The VRE is a research infrastructure developed by the Charité and
        ...
        <View style={styles.formGroup}>
          ...
          <Text style={styles.text}>
            ...
            Infrastructure and is the data controller for the personal
            information processed on the VRE Public Website
            (https://www.xxxxxx.de), unless otherwise stated. Charité’s legal
            address is: Charité – Universitätsmedizin Berlin, Charitéplatz 1,
          ...
          <Text style={styles.text}>
            ...
            protection issues in the VRE, can be submitted to the Data
            Protection Officer of the Charite here:
          </Text>
          <Text style={styles.text}>
            https://www.charite.de/en/service/data_protection/
          </Text>
        ...
        <View style={styles.formGroup}>
          ...
          <Text style={styles.text}>
            ...
            email to the following address:datenschutz@charite.de
          </Text>
        </View>
        ...
        <View style={styles.formGroup}>
          ...
          <View style={styles.formGroup}>
            ...
            <Text style={styles.subtext}>
              • Necessity for the performance of a task carried out in the
          ...
          <Text style={styles.text}>
            If you are employed by a VRE partner, your data will not be
            processed based on consent but rather to comply with a legal
            obligation, to perform a contract, or in some cases, for purposes of
          ...
          <Text style={styles.text}>
            Additionally, this VRE website logs the IP address used to access
            the website for security reasons.
          </Text>
          <Text style={styles.text}>
            Personal data may be processed to provide access to services offered
            by the VRE website, to facilitate collaboration among users of the
            VRE website and to contact users to keep them informed of events and
            news regarding VRE.
          </Text>
        </View>
        ...
        <View style={styles.formGroup}>
          ...
          <Text style={styles.text}>
            ...
            the VRE Consortium. All VRE partners are required by contract to
            meet all GDPR requirements. In some cases, VRE partners may publish
          ...
          <Text style={styles.text}>
            ...
            required by an administrative or court order, or with auditors.{' '}
          </Text>
        </View>
        ...
        <View style={styles.formGroup}>
          ...
          <Text style={styles.text}>
            ...
            and data providers. The VRE will process this data in accordance
            with applicable EU laws such as the GDPR on privacy and data
            protection.
          </Text>
        </View>
        ...
        <View style={styles.formGroup}>
          ...
          <Text style={styles.text}>
            No personal data collected from this VRE website is sold or
            otherwise shared for the purposes of direct marketing or other
            commercial purposes.
          </Text>
        </View>
        ...
        <View style={styles.formGroup}>
          ...
          <Text style={styles.text}>
            ...
            within the EU/EEA and to other countries that have been found to
            have adequate levels of protection by the European Commission
            including, but not limited to, Switzerland and Israel. All other
            personal data transfers are made with adequate safeguards in place
            including EC Standard Contractual Clauses, Binding Corporate Rules,
            or as part of the Privacy Shield Framework.
          </Text>
        </View>
        ...
        <View style={styles.formGroup}>
          ...
          <Text style={styles.text}>
            Cookies may be erased by the user at the end of each session. Some
            web browsers offer to do this automatically.
          </Text>
          <Text style={styles.text}>
          ...
          <Text style={styles.text}>
            ...
            interests of the data controller for the continued exploitation of
        ...
        <View style={styles.formGroup}>
          ...
          <View style={styles.formGroup}>
            ...
            <Text style={styles.subtext}>
              • the right to be informed (GDPR Articles 12-14, and Recitals 58
              and 60-62),{' '}
            </Text>
            <Text style={styles.subtext}>
            ...
            <Text style={styles.subtext}>
              • the right to erasure (GDPR Articles 18, 19 and Recital 67),{' '}
            </Text>
            <Text style={styles.subtext}>
        ...
        <View style={styles.formGroup}>
          ...
          <Text style={styles.text}>
            ...
            available here: https://kvkk.gov.tr/{' '}
          </Text>
        </View>
      </Page>
    </Document>
