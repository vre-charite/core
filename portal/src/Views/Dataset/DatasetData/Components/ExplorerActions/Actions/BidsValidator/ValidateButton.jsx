...
import { SyncOutlined, CloseOutlined, CloseCircleFilled, WarningFilled, WarningOutlined, CheckCircleTwoTone } from '@ant-design/icons';
...
export default function ValidateButton(props) {
    ...
    const openMessagePanel = async () => {
        ...
        if (treeData.length === 0) {
            message.error("There is no file in your dataset. Please import files before validation");
            return;
        }
