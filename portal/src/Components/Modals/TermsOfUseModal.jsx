  ...
  return (
    ...
    >
      ...
      >
        ...
        <p>
          The data and features available in the VRE are provided on an "as is"
          and "as available" basis. Please note that VRE features and content
          may contain bugs, viruses, errors, problems or other limitations. To
          the extent permitted by law, Charité and its service providers exclude
          any warranties (whether expressed or implied) for the VRE platform and
          data. This includes, but is not limited to, the disclaimer of any
          implied warranties of merchantability and fitness for a particular
          purpose of the VRE or of any data stored in the VRE.{' '}
        </p>
